...
const PrivacyPolicy = () => {
  ...
  useEffect(() => {
    request("GET", "cms/list", {}, { slug: "privacy-policy" }, true)
      .then((res) => {
  ...
  const onSubmit = async (data) => {
    ...
    const payload = {
      ...
      websiteContentType: "privacyPolicy",
    };

    request(
      "POST",
      "cms/edit",
      { cmsId: currentID, title: "Privacy Policy", description: payload.content },
      {},
      true
    )
      .then((res) => {
